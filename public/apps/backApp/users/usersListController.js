(function() {
    ...
    usersListController.$inject=['$scope', 'userFactory', '$filter', '$q'];

    function usersListController($scope, userFactory, $filter, $q) {
        ...
        function initPage(deferred, env){
            ...
            var usersDeffer = userFactory.getAllUsers().then( function(users){
